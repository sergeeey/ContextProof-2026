...
class ContextSession:
    ...
    contract: Optional[InformationContract] = None
    metadata: Dict[str, Any] = field(default_factory=dict)
...
class ContextReplayEngine:
    ...
    def replay(self, session_id: str) -> Optional[ContextSession]:
        """
        Replay сессии.
...
def get_replay_engine(storage_path: Optional[str] = None) -> ContextReplayEngine:
